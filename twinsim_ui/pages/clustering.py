                    ...
                    rx.hstack(
                        ...
                        rx.tooltip(
                            rx.text("Churn ⓘ", font_size="11px", font_weight="600",
                                    ...
                                    cursor="help"),
                            content="% of users in this cluster who stopped using the service in the last 30 days",
                        ),
                        rx.tooltip(
                            rx.text("Completion ⓘ", font_size="11px", font_weight="600",
                                    color=styles.BLUE, flex="1", text_align="center",
                                    cursor="help"),
                            content="% of sessions where users in this cluster watched content to the end",
                        ),
                        rx.tooltip(
                            rx.text("Reactivation ⓘ", font_size="11px", font_weight="600",
                                    color=styles.PURPLE, flex="1", text_align="center",
                                    cursor="help"),
                            content="Likelihood that a dormant user in this cluster comes back and watches again",
                        ),
